...
@Getter
@Setter
public class CreateCatalogAttributeOptionPayload {

    @NotBlank(message = "{validation.catalogOption.code.required}")
    @Size(max = 100, message = "{validation.catalogOption.code.tooLong}")
    private String code;
