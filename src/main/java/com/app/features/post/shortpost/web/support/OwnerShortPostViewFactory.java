package com.app.features.post.shortpost.web.support;
...
import com.app.features.post.shortpost.web.view.OwnerShortCardView;
...
public class OwnerShortPostViewFactory {
    ...
    public List<OwnerPostStatusFilterView> buildStatusFilters(
        ...
        return lifecycleViewSupport.buildStatusFilters(
                getOwnerPath(), lifecycleStatus, moderationStatus);
    }
