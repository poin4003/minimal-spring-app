...
public class PostModerationServiceImpl implements PostModerationService {
    ...
    @Override
    public Page<ModerationPostResult> getPosts(
            ModerationPostFilterCriteria criteria,
            Pageable pageable) {
        Page<PostEntity> entityPage = postRepo.findAll(
                PostModerationSpecification.filter(criteria),
                pageable);
    ...
    public void publishPost(UUID postId, UUID moderatorId) {
        postModerationCommandSvc.publishPost(postId, moderatorId);
    }
    ...
    public void rejectPost(
        ...
        postModerationCommandSvc.rejectPost(
                postId,
                moderatorId,
                payload.getReason());
    }
